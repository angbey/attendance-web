...
<?php
  ...
  $result = mysqli_query ($mysqli, "select * from absen_mahasiswa where kehadiran = 1 order by nim asc");
?>  
...
<html>
  ...
  <body>
    <div id="main">
        ...
        <tr>
          <?php
           while ($user_data = mysqli_fetch_array($result)) {
            echo "<tr>";
            echo "<td> <a href='add.php?nim=".$user_data['nim']."'><b>tambah</b></a> | ".$user_data['nim']."</td>";
      ...
      <div class='nav'>
      <a class='button-style' href='dosen-table.php'>Kembali</a>
      </div>
    </div>
  </body>
</html>